...
CREATE TABLE orders ( order_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, slot_id INTEGER NOT NULL, status INTEGER DEFAULT 1, order_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY(slot_id) REFERENCES slots (slot_id) );
...
--CREATE TABLE slots （ slot_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT ）;
